...
#define NORMAL_POLICY (0x10)
#define POWERSAVE_POLICY (0x00)
#define PERF_POLICY (0x20)
#define SPECIAL01 (0x30)
#define SPECIAL02 (0x40)
#define SPECIAL03 (0x50)
...
extern struct gpu_policy_info gpu_policy_normal[];
extern struct gpu_policy_info gpu_policy_powersave[];
extern struct gpu_policy_info gpu_policy_performance[];
