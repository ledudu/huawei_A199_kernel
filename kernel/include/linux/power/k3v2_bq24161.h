...
#define	BQ24161_COLD_BATTERY_THRESHOLD		(0)
 /*(10 ) battery temperature is 10 degree*/
#define	BQ24161_COOL_BATTERY_THRESHOLD		(10)
 /*( 45 ) battery temperature is 45 degree*/
#define	BQ24161_WARM_BATTERY_THRESHOLD		(45)
 /*( 52 ) battery temperature is 50 degree*/
#define	BQ24161_HOT_BATTERY_THRESHOLD		(52)
 /*( 3 ) battery temperature offset is 2 degree*/
#define	TEMPERATURE_OFFSET                  (2)
/* when temprature is high, limit the charge voltage, can change it by boardid config file */
#define BQ24161_TEMPRATURE_HIGH_LIMIT_VOLTAGE (4100)
/* when temprature is 0~10, limit the charge current(mA), can change it by boardid config file */
#define BQ24161_TEMPRATURE_LOW_LIMIT_CURRENT (500)
