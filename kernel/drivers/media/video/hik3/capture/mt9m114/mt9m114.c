...
static sensor_module mt9m114_sensor_module[] = {
	{"23060111FF-MT-S", MT9M114_CHIP_ID, MT9M114_SUNNY_SLAVE_ADDRESS, 0, mt9m114_sunny_init_regs, ARRAY_SIZE(mt9m114_sunny_init_regs)},
};
...
void mt9m114_set_awb(camera_white_balance awb_mode)
{
	...
	case CAMERA_WHITEBALANCE_AUTO:
		...
		mt9m114_write_reg(0xC8D0, 0x00A6, I2C_16BIT, 0x00);
		mt9m114_write_reg(0xC8D2, 0x008C, I2C_16BIT, 0x00);
		break;
	...
	case CAMERA_WHITEBALANCE_DAYLIGHT:
		...
		mt9m114_write_reg(0xC8D0, 0x00AF, I2C_16BIT, 0x00);  /* R/G */
		mt9m114_write_reg(0xC8D2, 0x0089, I2C_16BIT, 0x00);  /* B/G */
		break;
	case CAMERA_WHITEBALANCE_CLOUDY_DAYLIGHT:
		...
		mt9m114_write_reg(0xC8D0, 0x00B9, I2C_16BIT, 0x00);  /* R/G */
		mt9m114_write_reg(0xC8D2, 0x0096, I2C_16BIT, 0x00);  /* B/G */
		break;
	default:
...
static void mt9m114_set_default(void)
{
	...
	strcpy(mt9m114_sensor.info.name,"23060111FF-MT-S");
