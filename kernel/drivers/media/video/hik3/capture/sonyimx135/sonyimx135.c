...
#define SONYIMX135_ISO_UPPER_LIMIT	(1600)
#define SONYIMX135_ISO_LOWER_LIMIT	(100)
...
/* AWB */
	...
	{0x1cccf, 0x28},//B gain for A                                   
	{0x1ccd0, 0x10},//R gain for A         
	                          
	{0x1c5b8, 0x10},//B gain for C outdoor Richard@0517                       
	{0x1c5b9, 0x28},//R gain for C outdoor Richard@0517                       
	{0x1ccd1, 0x10},//B gain for C indoor Richard@0517                        
	{0x1ccd2, 0x28},//R gain for C indoor Richard@0517                        
	                  
	{0x1ccd3, 0xf4},//B gain for D indoor                                   
	{0x1ccd4, 0x30},//R gain for D indoor                                   
	{0x1cccc, 0xf4},//B gain for D outdoor                                  
	...
	{0x66209, 0x77}, //CWF X
	{0x6620a, 0x65}, //CWF Y
	{0x6620b, 0xf0}, //K_A_X2Y, a slop
	{0x6620c, 0xaf}, //K_D65_Y2X, d slop
	{0x6620d, 0x48}, //D65 Limit
	{0x6620e, 0x38}, //A Limit
	{0x6620f, 0x60}, //D65 split
	{0x66210, 0x52}, //A split
	{0x66201, 0x52},
...
{0x1c4a1, 0x33},
{0x1c4a2, 0x00},
{0x1c4a3, 0x33}, //gamma 2.0 0310 //avoid false contour Richard@0323
...
//add awb  shift detect parameter according 0x1c734~0x1c736
{0x1ccd5, 0x41}, //CT_A, 2012.06.02 yuanyabi
{0x1ccd6, 0x69}, //CT_C
{0x1ccd7, 0xb8}, //CT_D
...
{0x66207, 0x1c}, //A threshold, range DX  0x15
...
{0x1d977, 0x33},
{0x1d978, 0x02}, //dark image gamma
{0x1d979, 0x33},
{0x1d97a, 0x33}, //low gain slope
{0x1d97b, 0x33}, //high gain slope
{0x1d97c, 0x33}, //dark image slope
{0x1d97d, 0x14}, //low bright thres
{0x1d97e, 0x20}, //high bright thres
...
//dynamic CT AWB, huiyan 20120810 add for new firmware AWB
{0x1d924, 0x00}, //disable dynamic AWB for HDR
{0x1d950, 0x00},//Br thres,super highlight threshold
{0x1d951, 0x08},//Br thre
{0x1d952, 0x30},//Br Ratio,Ratio for transition region
...
static framesize_s sonyimx135_rgbw_es1_framesizes[] = {
	{0, 2, 2048, 1536, 4572, 1850, 30, 25, 0x19A, 0x155, 0x100, VIEW_FULL, RESOLUTION_4_3, true, {sonyimx135_rgbw_es1_framesize_2048x1536, ARRAY_SIZE(sonyimx135_rgbw_es1_framesize_2048x1536)} },
	{0, 2, 4160, 3120, 4572, 3142, 10, 5, 0x15D, 0x123, 0xA0, VIEW_FULL, RESOLUTION_4_3, false, {sonyimx135_rgbw_es1_framesize_full, ARRAY_SIZE(sonyimx135_rgbw_es1_framesize_full)} },
};
...
static framesize_s sonyimx135_rgb_framesizes[] = {
	...
	{0, 2, 2048, 1536, 4572, 2332, 30, 25, 0x2BB, 0x247, 0x100, VIEW_FULL, RESOLUTION_4_3, true, {sonyimx135_rgb_framesize_2048x1536, ARRAY_SIZE(sonyimx135_rgb_framesize_2048x1536)} },
	{0, 2, 4160, 3120, 4992, 3142, 10, 5, 0x15D, 0x123, 0xFF, VIEW_FULL, RESOLUTION_4_3, false, {sonyimx135_rgb_framesize_full, ARRAY_SIZE(sonyimx135_rgb_framesize_full)} },
};

static framesize_s sonyimx135_rgbw_es2_framesizes[] = {
	{0, 2, 2048, 1536, 4572, 1850, 30, 25, 0x19A, 0x155, 0x100, VIEW_FULL, RESOLUTION_4_3, true, {sonyimx135_rgbw_es2_framesize_2048x1536, ARRAY_SIZE(sonyimx135_rgbw_es2_framesize_2048x1536)} },
	{0, 2, 4160, 3120, 4572, 3142, 10, 5, 0x15D, 0x123, 0xA0, VIEW_FULL, RESOLUTION_4_3, false, {sonyimx135_rgbw_es2_framesize_full, ARRAY_SIZE(sonyimx135_rgbw_es2_framesize_full)} },
};
...
int sonyixm135_get_iso_limit(camear_iso_limit_t type )
{
	if( ISO_UPPER_LIMIT == type){
		return SONYIMX135_ISO_UPPER_LIMIT;
	}else if( ISO_LOWER_LIMIT == type){
		return SONYIMX135_ISO_LOWER_LIMIT;
	}else{
...
static void sonyimx135_set_default(void)
{
	...
	strcpy(sonyimx135_sensor.info.name, "sonyimx135");
	...
	sonyimx135_sensor.get_iso_limit = sonyixm135_get_iso_limit;
	...
	if (chip_id == DI_CHIP_ID) {
		for (i = 0; i < (ARRAY_SIZE(sonyimx135_framesizes)); i++)
			sonyimx135_framesizes[i].fps = sonyimx135_framesizes[i].fps_es;

		/* full size, add by y36721 */
		i = ARRAY_SIZE(sonyimx135_framesizes) - 1;
		sonyimx135_framesizes[i].sensor_setting.setting = sonyimx135_framesize_full_es;
		sonyimx135_framesizes[i].sensor_setting.seq_size = ARRAY_SIZE(sonyimx135_framesize_full_es);
	}
#endif
	//modiy format
