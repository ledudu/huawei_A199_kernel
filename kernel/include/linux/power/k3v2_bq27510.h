...
/* modify address of BQ27510 according TI's demmand */
/* Internal current */
#define   BQ27510_REG_II                            (0x22)
/*Time to Empty*/
#define	BQ27510_REG_TTE				(0x16)
/* not use TTF any more in chargelog as TI's demmand */
/*Time to Full*/
...
extern int k3_bq27510_battery_check_firmware_version(struct k3_bq27510_device_info *di);
extern const char* k3_bq27510_battery_get_firmware_version(struct k3_bq27510_device_info *di);
...
extern int k3_bq27510_get_gpadc_conversion(int channel_no);
extern int k3_get_battery_id(void);
#endif
