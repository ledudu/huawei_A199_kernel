...
config_pair  hw_U9510_configs [] = {
    ...
    {"product/name", (const unsigned int)(unsigned int*)"U9510", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_U9510= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_U9510,
	.data_array={.config_pair_ptr=hw_U9510_configs},
	.list={NULL,NULL},
};
