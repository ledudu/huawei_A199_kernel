	...
	if (ret == 0) {
		if ( (w_wdata == 1) && (status == 0) ) {
            ...
            case E_FELICA_BOARD_TYPE_U9701:
                ...
                regulator_set_voltage(felica_hvdd, 1800000, 1800000);
                regulator_enable(felica_hvdd);
                break;
	...
	if (ret == 0) {
		if ( (w_wdata == 1) && (status == 0) ) {
            ...
            case E_FELICA_BOARD_TYPE_U9700:
                ...
                regulator_set_voltage(felica_tvdd, 1800000, 1800000);
                regulator_enable(felica_tvdd);
                break;
            default:
                pr_err("felica_board_type unsupported\n");
                break;    
