...
#define FLASH_CHIP_ID_ADDR 0x07
#define FLASH_CHIP_ID_MASK 0x07
#define FLASH_CHIP_ID 0x06
...
static int tps61310_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	ret = tps61310_read_reg8(FLASH_CHIP_ID_ADDR, &val);
...
static struct device_attribute tps61310_led=
    __ATTR(tps61310_led_lightness, 0664, tps61310_led_torch_mode_get_brightness,
...
static int __init tps61310_module_init(void)
{
	...
	//Remove the register process to probe function
	#ifdef THERMAL_PROTECT 
